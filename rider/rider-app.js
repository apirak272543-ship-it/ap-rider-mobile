(() => {
  ...
  const app = (active, content) => {
    ...
    document.body.innerHTML = `<header class="mpa-topbar"><a class="mpa-brand" href="dashboard.html">AP Service · ไรเดอร์</a><nav class="mpa-nav">${nav}<a href="../rider.html" aria-label="เปิดหน้าไรเดอร์แบบเดิม">ระบบเดิม</a></nav></header><main class="mpa-shell" data-page-content>${content}</main>`;
  };
